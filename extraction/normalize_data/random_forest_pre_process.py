...
# Directory paths
examinations_path = "C:\\Users\\lucas\\Desktop\\gaitmasteris\\data\\extracted\\data_extracted\\examination.csv" 
...
def prepare_and_extract () :
    ...
    np.save("C:\\Users\\lucas\\Desktop\\gaitmasteris\\data\\extracted\\random_forest_formated\\x", X)
    np.save("C:\\Users\\lucas\\Desktop\\gaitmasteris\\data\\extracted\\random_forest_formated\\y", y)
